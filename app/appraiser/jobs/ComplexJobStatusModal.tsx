...
import { ProfileIcon3, BuildingIcon, UploadIcon, LoadIcon, ResidentialIcon, Notes, Comments } from "@/components/icons";
      ...
      <Dialog.Panel className="bg-white max-w-5xl w-full rounded-2xl shadow-lg relative max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-8 pt-16">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <label className="block mb-2 text-[#000000] font-urbanist font-semibold">Estimate Market Value</label>
              <div className="relative">
                <span className="absolute left-4 top-1/2 transform -translate-y-1/2 text-black font-bold text-lg">$</span>
                <input
                  type="text"
                  value={estimateMarketValue}
                  onChange={e => setEstimateMarketValue(e.target.value)}
                  required
                  className="w-full border border-gray-300 rounded-full px-10 py-3 focus:outline-none focus:ring-2 focus:ring-[#014F9D] focus:border-transparent"
            ...
            <div>
              <label className="block mb-2 text-[#000000] font-urbanist font-semibold">Effective Date</label>
              <input
                type="date"
                value={effectiveDate}
 ...
 <div className="grid grid-cols-2 gap-6">
              ...
              <div>
                ...
                <div className="border-2 border-dashed h-[11rem] border-gray-300 rounded-lg p-8 bg-gray-50 hover:bg-gray-100 transition-colors">
                  ...
                  />
                  <label htmlFor="file-upload-complex" className="cursor-pointer">
            ...
            <div>
              <label className="block mb-2 text-[#000000] font-urbanist font-semibold">Status</label>
              <div className="relative">
                <select 
