...
import { ResidentialIcon, LoadIcon } from "@/components/icons";
...
const ProposalForm: React.FC<ProposalFormProps> = ({ properties, onSuccess, loading: pageLoading }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div>
        <label className="block mb-2 text-xl font-semibold">Service Type</label>
      ...
      <div>
        <label className="block mb-2 text-xl font-semibold">Estimated Market Value</label>
        <div className="relative">
      ...
      {/* Fee for Appraiser */}
      <div>
        <label className="block mb-2 text-xl font-semibold">Fee for Appraiser</label>
        <div className="relative">
          <span className="absolute left-4 top-1/2 transform -translate-y-1/2 text-xl text-black font-bold select-none pointer-events-none">$</span>
          <input
            type="number"
