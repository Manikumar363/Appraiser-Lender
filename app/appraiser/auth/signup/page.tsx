...
export default function AppraiserSignUpPage() {
  ...
  return (
    <AuthLayout>
      ...
      <div className="mb-6">
        <h2 className="text-3xl font-bold text-gray-800 mb-4 ">Create Your Appraiser Account</h2>
      </div>
      ...
      <div className="text-center mt-6">
        ...
        <Link href="/appraiser/auth/signin" className="text-[#1e5ba8] font-medium hover:underline">
          Sign In
        </Link>
      </div>
    </AuthLayout>
