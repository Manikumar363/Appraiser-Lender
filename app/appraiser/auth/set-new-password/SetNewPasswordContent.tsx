        ...
        <div className="w-full max-w-[765px]">
          <div className="mb-8">
            ...
            <p className="text-gray-800 text-base mb-6">
              Create a strong password to secure your account and manage your
              jobs and updates.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full border border-gray-300 rounded-full px-16 py-4 text-sm text-gray-900 placeholder-gray-500 focus:outline-none focus:border-[#2A020D] pr-20"
            ...
            <button
              ...
              className={`w-full bg-[#2A020D] text-white py-4 rounded-full font-medium transition-all duration-200 ${
                isFormValid && !loading
                  ? "hover:bg-[#2A020D] transform hover:scale-[1.02]"
