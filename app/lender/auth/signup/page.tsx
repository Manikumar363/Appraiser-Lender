...
export default function LenderSignUpPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!acceptTerms) return toast.error("Please accept the Terms of Use and Privacy Policy.")
  ...
  const handleRoleChange = (role: "appraiser" | "lender") => {
    ...
    if (role === "appraiser") router.push("/appraiser/auth/signup")
  }

  return (
    <AuthLayout>
      <Toaster position="top-right" />
      <div className="w-full flex flex-col items-center px-5 sm:px-8 pt-10 sm:pt-14">
        {/* Header + Role Selector */}
        <div className="w-full max-w-[765px] mx-auto mb-6 space-y-4">
        ...
        {/* Title */}
        <div className="w-full max-w-[765px] mx-auto mb-6">
          <h2
            className="text-[34px] sm:text-[42px] font-semibold text-gray-800 leading-[105%] mb-2"
        ...
        <div className="w-full max-w-[765px] mx-auto">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            {/* Password (external toggle, since auth-input cannot be edited) */}
            ...
            <div className="relative">
              <PhoneInput
                ...
                inputClass="!w-full !h-[52px] !text-base !pl-[58px] !pr-4 !rounded-full !border !border-black focus:!border-[#2A020D] focus:!shadow-md"
            ...
            <button
              type="submit"
              className="w-full bg-[#2A020D] text-white py-4 rounded-full font-semibold hover:bg-[#4e1b29] transition-colors text-base shadow-sm disabled:opacity-50"
              disabled={loading}
            >
